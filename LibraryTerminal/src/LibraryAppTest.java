...
class LibraryAppTest {
	...
	void bookConditionTest() {
		...
		assertEquals(100, bookCondition);
	}
	...
	@Test
	void manuallyCreateBookMultipleAuthor() {
		ArrayList<String> actual = new ArrayList<>();

		String author = "Joe Smith, John Doe, Jane Doe";
		String[] authorArr = author.split(",");
		for (String a : authorArr) {
			a = a.trim();
			actual.add(a);
		}
		ArrayList<String> expected = new ArrayList<>(Arrays.asList("Joe Smith", "John Doe", "Jane Doe"));
